...
gcp_broad_gatk_hg19 <- addMeta(gcp_broad_gatk_hg19,
...
gcp_broad_gatk_hg19 <- addMeta(gcp_broad_gatk_hg19,
                               ...
                               extensions = list(author = "rworkflow team",
                                                 date = Sys.Date(),
                                                 url = "https://storage.googleapis.com/gcp-public-data--broad-references/hg19/v0/",
                                                 example = paste("rcp <- recipeLoad('gcp_broad_gatk_hg19')",
